...
/* package */ class HlsChunkSource {
  ...
  public void getNextChunk(
    ...
    String source = mediaPlaylist.baseUri;
    if(bufferedDurationUs/1000000>2){
      source = source.replace("cdn2.","cdn3.");
    }
    else if(bufferedDurationUs/1000000>1){
      source = source.replace("cdn2.","cdn2.");
    }
    else
      source = source.replace("cdn2.","cdn1.");

    Uri chunkUri = UriUtil.resolveToUri(source, segment.url);
